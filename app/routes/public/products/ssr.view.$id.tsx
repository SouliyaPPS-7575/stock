...
const RouteComponent = memo(() => {
  ...
  // Early return for no data (optional, depends on fetchProduct behavior)
  if (!data) {
  ...
  // Memoized thumbnail rendering to avoid re-renders
          ...
          <div className='grid grid-cols-1 gap-4 w-full max-w-4xl place-items-center text-center mx-auto'>
            <div className='flex flex-col justify-center items-center relative w-full'>
              <ImageAntd
                ...
                preview={true} // Disable Antd preview for faster rendering
              />
              {/* Navigation Buttons */}
...
// Ensure displayName for memo debugging
