...
import { l as ln, e as eo } from '../nitro/nitro.mjs';
...
const R = (c) => ({ editProduct: useMutation({ mutationFn: (r) => eo("products", c, r), onSuccess: () => {
...
//# sourceMappingURL=edit-ClsImU3l.mjs.map
