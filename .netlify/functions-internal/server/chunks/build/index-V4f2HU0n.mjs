...
import { _ as _n, E, Z } from '../nitro/nitro.mjs';
import { Button, Link, Badge, Card, CardBody, CardFooter } from '@heroui/react';
...
const O = ({ collection: t, pageSize: e = 12, sort: o = "created" }) => {
  ...
  const v = H({ hasNextPage: !!x, isFetchingNextPage: f, fetchNextPage: l });
  return { items: y, loadMoreRef: v, isLoading: b, isFetchingNextPage: f };
}, ue = function() {
  const { items: e, loadMoreRef: o, isLoading: s, isFetchingNextPage: n } = O({ collection: "products", pageSize: 12 });
  return s ? jsx(_n, {}) : jsxs("div", { className: "p-2 z-0 min-h-screen", children: [jsx(F, { products: e }), n && jsx(_n, {}), jsx("div", { ref: o, className: "h-10" }), jsx(Button, { color: "primary", className: "fixed bottom-20 right-4 p-4 rounded-full shadow-lg focus:outline-none z-10", as: Link, href: "/products/create", children: "+ Create" })] });
};

export { ue as component };
//# sourceMappingURL=index-V4f2HU0n.mjs.map
